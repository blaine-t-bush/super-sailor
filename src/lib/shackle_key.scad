...
module shackle_key(length_shaft, base_width_fid, base_width_marlinespike, chisel_width_marlinespike, desired_length, offset, thickness) {
  ...
  tan_taper_y = 2*length_shaft/(base_width_marlinespike - chisel_width_marlinespike);
  ...
  length_s = min(base_width_marlinespike*tan_taper_y/2 - thickness*tan_taper_y/sin_taper_y - offset, desired_length);
  width_s_base = max(base_width_marlinespike - 2*(offset/tan_taper_y + thickness/sin_taper_y), 0);
  width_s_top = max(base_width_marlinespike - 2*((length_s + offset)/tan_taper_y + thickness/sin_taper_y), 0);
  ...
  modified_width_s_top = base_width_marlinespike - 2*((length_s_straight + offset)/tan_taper_y + thickness/sin_taper_y);
